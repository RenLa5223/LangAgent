...
一个自托管的 AI 对话项目，支持微信原生接入和 Web 界面对话。
...
> ⚠️ **微信接入说明：** 本项目采用直接调用底层 iLink 协议的方式接入，未经过官方 OpenClaw SDK。此方式存在较高的协议失效及账号风控风险，**强烈建议仅使用测试号进行学习与研究**，请勿用于生产环境或绑定重要账号，封号风险请自行承担。
